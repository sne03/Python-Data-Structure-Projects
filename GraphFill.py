...
# class for a graph node; contains x and y coordinates, a color, a list of edgesand
...
class ImageGraph:
    ...
    def print_image(self):
        img = [["black" for i in range(self.image_size)] for j in
...
def create_graph(data):
    ...
    for i in range(node_count):
        ...
        new_node = ColorNode(len(graph.nodes), int(node_info[0]),
int(node_info[1]), node_info[2])
